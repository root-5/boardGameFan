...
export default function Score() {
  ...
  return (
    <>
      <div
        className='relative p-4 w-56 h-56 text-center bg-gray-700'
      >
        <input
          ...
          <div className='flex justify-center align-middle gap-2 text-base'>
            <div className=''>
              <div 
                ...
                onClick={() => {setCount(ajustScoreValue(count - 1))}}
              >
                {'<'}
              </div>
              <div 
                className='px-2 cursor-pointer opacity-100 hover:opacity-70'
                onClick={() => {setCount(ajustScoreValue(count - 10))}}
              >
                -10
              </div>
              <div 
                className='px-2 cursor-pointer opacity-100 hover:opacity-70'
                onClick={() => {setCount(ajustScoreValue(count - 100))}}
              >
                -100
              </div>
              <div 
                className='px-2 cursor-pointer opacity-100 hover:opacity-70'
                onClick={() => {setCount(ajustScoreValue(count - 1000))}}
              >
                -1000
              </div>
              <div 
                className='px-2 cursor-pointer opacity-100 hover:opacity-70'
                onClick={() => {setCount(ajustScoreValue(count - 10000))}}
              >
                -10000
              </div>
            </div>
